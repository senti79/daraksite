...
const faqs = [
  ...
  { q: '다락서원 운영의 가장 큰 장점은 무엇인가요?', a: '정해진 시간에만 수업하는 시스템으로 보강 부담이 없으며, 본사 직영점 운영 노하우를 실시간으로 공유받을 수 있습니다. 본사가 직영으로 운영하면서 교재를 지속적으로 업데이트합니다.' },
];
...
const Franchise: React.FC = () => {
  ...
  return (
    <section id="franchise" className="py-20 lg:pt-32 lg:pb-10 bg-white">
