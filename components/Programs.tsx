...
const programData = {
  '초등 저학년': [
    { name: '초등 봄 1 (10단계)', description: '우리말의 아름다움을 담은 책 80여 권을 읽고 씁니다.', color: 'border-[#D97706]' },
    { name: '초등 봄 2 (10단계)', description: '인문을 넘어 사회로 시각을 확장하는 책 80여 권을 읽고 씁니다.', color: 'border-[#D97706]' },
    { name: '초등 여름 1 (10단계)', description: '인문, 사회, 과학 등 다양한 분야의 책 80여 권을 읽고 씁니다.', color: 'border-[#D97706]' },
  ],
  '초등 고학년': [
    { name: '초등 여름 2 (9단계)', description: '인문, 사회, 과학, 예술, 철학 등 72여 권을 읽고 씁니다.', color: 'border-[#B45309]' },
    { name: '초등 가을 (10단계)', description: '물, 화, 생, 지, 경제, 법 등 심화 분야 80여 권을 읽고 씁니다.', color: 'border-[#B45309]' },
    { name: '초등 겨울 (9단계)', description: '중등 교과 연계 도서 위주로 72여 권을 읽고 씁니다.', color: 'border-[#B45309]' },
  ],
  '중등': [
    { name: '중등 봄 (9단계)', description: '중·고등 교과 수록 인문, 사회, 과학 도서 70여 권을 읽습니다.', color: 'border-[#92400E]' },
    { name: '중등 여름 (6단계)', description: '고등 내신 및 수능 독서 완벽 대비를 위한 40여 권을 읽습니다.', color: 'border-[#92400E]' },
  ],
  '역사': [
    { name: '초등 한국사', description: '구석기부터 근현대사까지 책 50여 권으로 한국사 흐름을 잡습니다.', color: 'border-[#D97706]' },
    { name: '중등 한국사', description: '선사시대부터 근현대까지, 중등 한국사를 한 번에 끝냅니다.', color: 'border-[#D97706]' },
    { name: '중등 세계사', description: '선사시대부터 근현대사까지, 중·고등 세계사를 한 번에 끝냅니다.', color: 'border-[#D97706]' },
  ],
};
    ...
    <section id="programs" className="py-20 md:py-32 bg-white">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-lg text-gray-600 font-dodum">"현장의 경험으로 매년 더 좋은 책을 발굴하고 문항을 만듭니다."</p>
        </div>
          ...
          {Object.keys(programData).map((tab) => (
            <button
              ...
              className={`px-4 py-2 md:px-6 md:py-3 rounded-full text-sm md:text-base font-semibold transition-all duration-300 ${
                activeTab === tab ? 'bg-[#92400E] text-white shadow-lg' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
              }`}
            >
              {tab}
            </button>
