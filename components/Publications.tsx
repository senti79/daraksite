...
const publications = [
    {
        ...
        images: [
            '/daraksite/PhotoshopExtension_Image.png',
            '/daraksite/PhotoshopExtension_Image (1).png',
            '/daraksite/PhotoshopExtension_Image (2).png',
            '/daraksite/PhotoshopExtension_Image (3).png',
            '/daraksite/PhotoshopExtension_Image (4).png',
            '/daraksite/PhotoshopExtension_Image (5).png',
            '/daraksite/PhotoshopExtension_Image (6).png',
            '/daraksite/PhotoshopExtension_Image (7).png',
        ]
    },
    {
        title: '다락서원 독후감',
        ...
        images: [
            '/daraksite/PhotoshopExtension_Image (9).png',
            '/daraksite/PhotoshopExtension_Image (10).png',
            '/daraksite/PhotoshopExtension_Image (11).png',
            '/daraksite/PhotoshopExtension_Image (12).png',
            '/daraksite/PhotoshopExtension_Image (13).png',
            '/daraksite/PhotoshopExtension_Image14.png',
            '/daraksite/PhotoshopExtension_Image15.png',
            '/daraksite/PhotoshopExtension_Image16.png',
            '/daraksite/PhotoshopExtension_Image17.png',
            '/daraksite/PhotoshopExtension_Image18.png',
            '/daraksite/PhotoshopExtension_Image19.png',
            '/daraksite/PhotoshopExtension_Image20.png',
        ]
    }
];
