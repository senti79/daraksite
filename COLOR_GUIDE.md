...
| **하이라이트** | `#BE7E56` (Opacity 30%) | `.text-highlight` 애니메이션 레이어 |
...
이 프로젝트는 CDN을 통해 Tailwind를 사용하며, 특정 색상은 임의값(Arbitrary values)으로 적용되었습니다.
